...
def merge_datasets(descriptions, people, salaries):
    """
    Merge the three datasets based on the column 'id'

    Parameters
    ----------
    descriptions : pd.DataFrame
        The DataFrame containing the descriptions data.
    people : pd.DataFrame
        The DataFrame containing the people data.
    salaries : pd.DataFrame
        The DataFrame containing the salaries data.
    ...
    """
    df = people.merge(descriptions, on='id').merge(salaries, on='id')
